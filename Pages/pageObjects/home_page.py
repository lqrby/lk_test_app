...
#         while number > 0:
#             tv_plays = self.get_elements(RPL.tv_play)
...
#                         break
#                 if number > 0:
#                     if self.is_element_exist(RPL.no_more):
#                         log.info("显示了没有更多")
#                         number = 0
#                         break
#                     else:
#                         log.info("向上滑动列表")
#                         self.swipeUp()
#             elif self.is_element_exist(RPL.no_more):
#                 log.info("没有更多")
#                 number = 0
#                 break
#             else:
...
#         while number > 0:
#             tv_desArr = self.get_elements(RPL.tv_close)
#             log.info("列表数据有{}条".format(len(tv_desArr)))
#             if len(tv_desArr) > 0:
#                 for no_play in tv_desArr:
#                     time.sleep(3)
#                     no_play.click()
#                     self.wait_eleVisible(RPL.tv_nick)
...
# #         self.wait_element_clickable(RPL.lucky_bag_iv)
# #         self.click_element(RPL.lucky_bag_iv)#点击福袋
# #         self.driver.keyevent(4)

    
# #     #礼物顶部入口
# #     def gift_entrance_top(self):
# #         self.wait_element_clickable(RPL.masterAvatarView)
# #         self.click_element(RPL.masterAvatarView)#点击礼物入口

# #     #礼物底部入口
# #     def gift_entrance_bottom(self):
# #         self.wait_element_clickable(RPL.iv_first_recharge)
# #         self.click_element(RPL.iv_first_recharge)#点击礼物入口
 
# #     #切换礼物tap
# #     def get_gift_tap(self):
# #         for i,tapBtn in enumerate(RPL.gift_list):
...
# #         time.sleep(2)
# #         giftPages = self.get_elements(RPL.gift_pages) #某tap下当前页的所有礼物元素
# #         if giftPages.__len__() > 0:
# #             number = random.randint(0, giftPages.__len__())
# #             self.click_element(RPL.get_gift(number))
# #             # giftPages[number].click()
# #             time.sleep(2)
            
# #     #赠送礼物
# #     def give_gifts(self):
# #         self.wait_element_clickable(RPL.btn_send_gift)
# #         self.click_element(RPL.btn_send_gift) #点击某个礼物tap

# #     #查看房主资料
# #     def look_homeowner_data(self):
# #         self.wait_element_clickable(RPL.homeowner_data)
# #         self.click_element(RPL.homeowner_data) #点击房主资料
# #         data = self.driver.page_source
# #         self.wait_element_presence(RPL.personIdView)
# #         self.wait_element_presence(RPL.nick) #昵称
# #         self.follow_ta() #关注
# #         self.chat() #聊天
...
# #     #@ta
# #     def ait_ta(self):
# #         self.wait_element_clickable(RPL.reference)
# #         self.click_element(RPL.reference) # 点击@ta
# #         self.driver.press_keycode(4)

# #     #资料内点击关注
# #     def follow_ta(self):
# #         self.wait_element_clickable(RPL.attentionBtn)
# #         self.click_element(RPL.attentionBtn) # 点击关注

# #     #资料内点击打赏
# #     def reward(self):
# #         self.wait_element_clickable(RPL.sendBtn)
# #         self.click_element(RPL.sendBtn) # 点击打赏
# #         self.wait_element_clickable(RPL.homeowner_data)
# #         self.click_element(RPL.homeowner_data) #点击房主资料

# #     #资料内点击聊天
# #     def chat(self):
# #         self.wait_element_clickable(RPL.msgBtn)
# #         self.click_element(RPL.msgBtn) # 点击聊天
# #         self.wait_element_clickable(RPL.msg_backBtn)
# #         self.click_element(RPL.msg_backBtn) # 点击返回


# #     # 点击房间热度值
# #     def click_heat_value(self):
# #         self.wait_element_clickable(RPL.tv_heat)
# #         self.click_element(RPL.tv_heat) #点击某个礼物tap
# #         time.sleep(2)
# #         self.wait_element_clickable(RPL.heat_value)
# #         self.click_element(RPL.heat_value) #在线列表
# #         time.sleep(2)
# #         self.wait_element_clickable(RPL.vip_seat)
# #         self.click_element(RPL.vip_seat) #贵宾席位列表
# #         self.driver.press_keycode(4)
# #         time.sleep(2)

# #     #点击排行榜
# #     def click_rankingList(self):
# #         self.wait_element_clickable(RPL.ranking_list)
# #         self.click_element(RPL.ranking_list) #点击排行榜
# #         time.sleep(2)
# #         self.wait_element_clickable(RPL.contribution_list)
# #         self.click_element(RPL.contribution_list) #点击贡献榜
# #         time.sleep(2)
# #         self.wait_element_clickable(RPL.popularity_list)
# #         self.click_element(RPL.popularity_list) #点击人气榜
# #         time.sleep(2)
# #         self.wait_element_clickable(RPL.guardian_list)
# #         self.click_element(RPL.guardian_list) #点击守护榜
# #         time.sleep(2)
# #         self.driver.press_keycode(4)
# #         time.sleep(2)
...
# #         time.sleep(2)
# #         self.click_element(RPL.tv_introduce)#点击玩法介绍  
# #         time.sleep(1)
# #         result = self.driver.page_source
# #         assert "一" in result
# #         self.click_element(RPL.closeIv)#关闭玩法介绍
    
# #     #点击麦下
# #     def click_wheat_lower(self):
# #         time.sleep(1)
# #         self.click_wheatList()
# #         self.click_element(RPL.layout_people)#点击麦下
# #         time.sleep(1)
# #         self.click_wheatList()
    
# #     # 点击麦下用户列表
# #     def click_wheatList(self):
# #         if self.is_element_exist(RPL.iv_head_view):
# #             self.click_element(RPL.iv_head_view)#点击麦下收缩列表
# #             time.sleep(2)
# #             self.driver.keyevent(4)
# #         else:
# #             pass
...
# #     # 点击游戏
# #     def click_game(self):
# #         self.click_element(RPL.iv_game)#点击游戏
# #         time.sleep(2)
